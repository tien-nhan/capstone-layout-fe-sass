    ...
    <div id="ungdung">
      <div className="jss117">
        <div className="jss118">
          <div className="row">
            <div class="col-lg-6 ">
              <div class="jss119 text-center text-lg-left">
                <div>
                  <p class="jss120">Ứng dụng tiện lợi dành cho</p>
                  <p class="jss120">người yêu điện ảnh</p>
                  <br />
                  <p>
            ...
            <div className="col-lg-6">
              <div className="jss121">
                <img class="jss122" src="/images/mobile.png" alt="mobile" />
